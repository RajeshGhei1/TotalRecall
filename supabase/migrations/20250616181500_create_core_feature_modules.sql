...
INSERT INTO public.system_modules (name, description, category, is_active, version, default_limits) VALUES
('Dashboard Analytics', 'Advanced dashboard with analytics and insights', 'analytics', true, '1.0.0', '{"max_widgets": 10, "data_retention_days": 30}'),
('Predictive Insights', 'AI-powered predictive analytics and business insights', 'analytics', true, '1.0.0', '{"max_predictions": 100, "historical_data_months": 12}'),
('Workflow Management', 'Intelligent workflow automation and management', 'automation', true, '1.0.0', '{"max_workflows": 20, "max_steps_per_workflow": 50}'),
('User Management', 'Basic user and tenant management capabilities', 'core', true, '1.0.0', '{"max_users": 5}');
