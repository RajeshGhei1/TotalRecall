...
// This is a legacy version of the useCustomFields hook
// It's kept for backward compatibility but will be deprecated in future versions
// Please use the new hooks from the customFields directory instead
