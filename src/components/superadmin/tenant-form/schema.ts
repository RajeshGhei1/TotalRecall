...
export const formOptions = {
  regionOptions: ["North America", "South America", "Europe", "Asia", "Africa", "Australia"],
  countryOptions: ["United States", "Canada", "United Kingdom", "India", "Australia", "Germany"],
  industryOptions: ["Technology", "Finance", "Healthcare", "Manufacturing", "Retail", "Education"],
  companyTypeOptions: ["Public", "Private", "Non-profit", "Government"],
  entityTypeOptions: ["LLC", "Corporation", "Partnership", "Sole Proprietorship"],
  segmentOptions: ["Small", "Medium", "Large", "Enterprise"],
  endUserOptions: ["Enterprise EndUser", "SMB", "Consumer", "Government"],
};
