    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/admin/revenue" element={<Navigate to="/superadmin/dashboard" replace />} />
          ...
          {/* Redirect legacy routes to new unified dashboard */}
          <Route path="/superadmin/analytics" element={<Navigate to="/superadmin/dashboard" replace />} />
          <Route path="/superadmin/analytics-business-intelligence" element={<Navigate to="/superadmin/dashboard" replace />} />
          <Route path="/superadmin/revenue" element={<Navigate to="/superadmin/dashboard" replace />} />
